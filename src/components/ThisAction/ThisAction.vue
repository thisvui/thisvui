<template>
  <span :class="containerClass">
    ...
    >
      ...
      <this-icon v-if="icon" :icon="icon" :class="iconClass"></this-icon>
    </a>
    <this-modal
...
<script>
import { ValidationBus } from "../ThisValidation/validation-bus.js";
import sizes from "../../mixins/sizes";
import colors from "../../mixins/colors";
import common from "../../mixins/common";
import CssArchitect from "../../utils/css-architect";
import ThisModal from "../ThisModal/ThisModal";
...
export default {
  ...
  computed: {
     ...
     */
    getClasses: function() {
      const cssArchitect = new CssArchitect("this-action");

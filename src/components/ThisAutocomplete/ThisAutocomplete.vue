...
export default {
  ...
  computed: {
    ...
    getAutocompleteContainerClass: function() {
      const cssArchitect = new CssArchitect("field this-autocomplete");
    ...
    getAutocompleteResultsClass: function() {
      const cssArchitect = new CssArchitect(
        "this-autocomplete-results message"
      );
    ...
    getAutocompleteResultClass: function() {
      const cssArchitect = new CssArchitect("this-autocomplete-result hero");
